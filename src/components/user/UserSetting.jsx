                    ...
                    {isEditing && (
                      <div className="mt-4 flex justify-end space-x-2 border-t border-gray-100 pt-4">
                        <button
                          ...
                          className="rounded-md bg-blue-50 px-3 py-1.5 text-xs font-medium text-blue-700 hover:bg-blue-100 disabled:cursor-not-allowed disabled:opacity-50"
                        >
          ...
          {isEditing && (
            <div className="flex justify-end gap-3 pt-4">
              ...
              <button
                ...
                className="flex items-center justify-center rounded-md border border-transparent bg-[#0b8263] px-4 py-2 text-sm font-medium text-white hover:bg-teal-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none disabled:opacity-70"
              >
                {status === "updating" ? (
                  <>
