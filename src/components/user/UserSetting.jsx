  ...
  return (
    <div className="font-mont mx-auto max-w-md px-4 py-8 sm:max-w-lg sm:px-6 lg:max-w-6xl lg:px-8">
      <div className="rounded-lg bg-white p-6 shadow-xl">
        ...
        <div className="mb-6 flex flex-col items-start justify-between gap-6 border-b pb-6 sm:flex-row sm:items-center">
          <div className="flex flex-col items-center gap-6 md:flex-row">
            <ProfileImageUploader
              currentImage={`${import.meta.env.VITE_API_URL}${profileImage}`}
