...
//   //     setExistingPhotos((prev) => prev.filter((img) => img !== imagePath));
//   //   } catch (error) {
...
//       setError(`You can upload only ${remaining} more images`);
//       return;
//     }
...
//     try {
//       await request.deleteServiceImage({ serviceId, imagePath, type: "photo" });
...
//               <label className="flex h-32 cursor-pointer items-center justify-center rounded-md border-2 border-dashed text-gray-400">
//                 +
//                 <input
//                   type="file"
//                   accept="image/*"
...
//                 className="absolute top-2 right-2 rounded-full bg-red-600 px-2 py-1 text-xs text-white"
//               >
